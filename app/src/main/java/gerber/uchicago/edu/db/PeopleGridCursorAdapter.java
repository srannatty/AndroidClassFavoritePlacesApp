 ...
 */
public class PeopleGridCursorAdapter extends SimpleCursorAdapter {

    private ImageLoader mImageLoader;
    private RequestQueue mRequestQueue;

    public PeopleGridCursorAdapter(Context context, int layout, Cursor c, String[] from, int[] to, int flags) {
