...
import gerber.uchicago.edu.db.PeopleSimpleCursorAdapter;

/**
 * Created by jennifer1 on 5/31/15.
 */
public class Tab1List extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mListView = (ListView) getActivity().findViewById(R.id.person_list);
        ...
        mAdapter = new SimpleCursorAdapter
                ...
                new int[]{R.id.person_list_name, R.id.person_list_Phone}, // Where to put the retrieved information
                0
        );
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //TODO no data is being used right now
        return v;
    }
